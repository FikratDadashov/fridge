...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{url('assets\images\fridge.jpg')}}">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{url('/')}}">
                    ...
                    <b class="logo-icon">
                        ...
                        <!-- Dark Logo icon -->
                        <img src="{{url('assets\images\fridge.jpg')}}" width="50px" alt="homepage" class="dark-logo">
                        <!-- Light Logo icon -->
                    ...
                    <span class="logo-text">
                        <h3 style="color: black; text-align: center; margin-top: 5px;">Fridge</h3>
                    </span>
                </a>
                <!-- ============================================================== -->
                <!-- End Logo -->
